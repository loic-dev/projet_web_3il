...
$editStruct->setPassword($_POST["currentPassword"]);

try {
    $editStruct::fetchUserData();
    $editStruct->__verifyPassword();
    $editStruct->setPassword($_POST["newPassword"]);
    $editStruct::isPasswordWeak();
    $editStruct->updateDbPassword($editStruct::encryptPassword());
